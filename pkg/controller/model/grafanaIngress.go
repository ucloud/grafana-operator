						...
						Paths: []v1beta1.HTTPIngressPath{
							{
								...
								Backend: v1beta1.IngressBackend{
									ServiceName: getGrafanaServiceName(cr),
...
func getGrafanaIngressName(cr *v1alpha1.Grafana) string {
	return fmt.Sprintf("%s-%s", grafanaIngressName, cr.Name)
}
