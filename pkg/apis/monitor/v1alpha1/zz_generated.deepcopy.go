...
func (in *GrafanaDataSourceSpec) DeepCopyInto(out *GrafanaDataSourceSpec) {
	*out = *in
	out.Datasources = in.Datasources
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrafanaDatasourceRef) DeepCopyInto(out *GrafanaDatasourceRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrafanaDatasourceRef.
func (in *GrafanaDatasourceRef) DeepCopy() *GrafanaDatasourceRef {
	if in == nil {
		return nil
	}
	out := new(GrafanaDatasourceRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GrafanaSpec) DeepCopyInto(out *GrafanaSpec) {
	*out = *in
	...
	if in.DatasourceLabelSelector != nil {
		in, out := &in.DatasourceLabelSelector, &out.DatasourceLabelSelector
		*out = make([]*metav1.LabelSelector, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *GrafanaStatus) DeepCopyInto(out *GrafanaStatus) {
	*out = *in
	...
	if in.InstalledDatasources != nil {
		in, out := &in.InstalledDatasources, &out.InstalledDatasources
		*out = make([]*GrafanaDatasourceRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(GrafanaDatasourceRef)
